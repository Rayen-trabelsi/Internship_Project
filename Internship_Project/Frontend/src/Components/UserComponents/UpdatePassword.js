...
function UpdatePassword() {
    ...
    const [PassswordId, setPassswordId] = useState("");
    ...
    useEffect(() => {
        const fetchData = async () => {
            console.log(passId)
                    const result= await axios.get(`https://localhost:7010/api/User/GetPassword/${passId}`)
    ...
    const UpdatePass = async () => {
        ...
        await axios.put(`https://localhost:7010/api/User/UpdatePassword/${passId}`,{
            website: website,
            password: password,
            visible: visible
          })
                                    ...
                                    <form >
                                        ...
                                        <div className="card-body">
                                            <form role="form">
                                                ...
                                                <div className="mb-3">
                                                    <input type="text" className="form-control form-control-lg form-SignIn" placeholder={website} aria-label="Website" name="Website" value={website} onChange={(e) => setwebsite(e.target.value)} required />
                                                </div>
...
{errorMessage2 && (
                                                ...
                                                <div className="px-3 d-flex mt-4">
                                                    <div className="px-3">
                                                    <Button variant="success" onClick={() => UpdatePass()} className="mt-3" >
                                                        Update password
                                                    </Button>
                                                    </div>
                                                    

                                                    <Button variant="warning" onClick={() => { navigate("/ListPasswords") }} className="mt-3" >
                                                        Cancel
                                                    </Button>
                                                </div>
