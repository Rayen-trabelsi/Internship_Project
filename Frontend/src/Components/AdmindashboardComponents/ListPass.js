                            ...
                            <div className="col-12 mt-2">
                                <div className="card mb-4">
                                    <div className="card-header pb-0 d-flex justify-content-between">
                                        ...
                                        <Button variant="success" onClick={() => navigate("/AddnewPasswordAdmin")} >
                                            ...
                                            <table className="table align-items-center mb-0">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {/* <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-9 ps-2">Visible</th> */}
                                                ...
                                                <tbody>
                                                    {Passwords.map((e) => (
                                                        <tr key={e.userId}>
                                                            ...
                                                            {/* <td>
                                                                <p className="text-xs font-weight-bold mb-0">{e.visible}</p>
                                                            </td> */}
                                                            ...
                                                            <td className="align-middle text-center text-sm">
                                                                <Button variant="warning" onClick={() => navigate(`/UpdatePass/${e.passwordId}`)}>
